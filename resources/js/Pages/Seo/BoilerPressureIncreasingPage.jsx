...
export default function BoilerPressureIncreasingPage() {
    return (
        <>
            <Head title="Boiler Pressure Keeps Increasing" />

            <div className="min-h-screen bg-white text-gray-900 rounded-b-3xl">
                <Header title="Boiler Pressure Keeps Increasing" />

                <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 pt-28 pb-16">
                    <h1 className="text-3xl sm:text-5xl font-extrabold tracking-tight">
                        Boiler pressure keeps increasing: what it means
                    </h1>
                    <p className="mt-4 text-gray-700 leading-7">
                        If pressure rises above normal and you need to keep
                        releasing water, likely causes include a faulty filling
                        loop, expansion vessel charge issue, or internal valve
                        faults.
                    </p>

                    <section className="mt-8 rounded-xl border border-gray-200 p-6">
                        <h2 className="text-2xl font-bold">Quick checks</h2>
                        <ul className="mt-4 list-disc pl-5 space-y-2 text-gray-700">
                            <li>Ensure the filling loop is fully closed.</li>
                            <li>Note pressure when cold vs when heating is on.</li>
                            <li>Look for any discharge pipe dripping outside.</li>
                        </ul>
                    </section>

                    <section className="mt-6 rounded-xl border border-blue-200 bg-blue-50 p-6">
                        <h2 className="text-xl font-bold text-blue-900">Next best step</h2>
                        <p className="mt-3 text-blue-900">
                            Book a boiler service first. A full service may
                            resolve some issues and also help identify whether you need
                            a repair. If you prefer, you can book a repair
                            directly.
                        </p>
                    </section>
